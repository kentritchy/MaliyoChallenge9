...
public class LevelManager : MonoBehaviour
{
    ...
    private const float DISTNACE_BEFORE_SPAWN = 100.0f;
    ...
    private void Update()
    {
        if (currentSpawnZ - cameraContainer.position.z < DISTNACE_BEFORE_SPAWN)
            GenerateSegment();
    ...
    {
        List<Segment> possibleSeg = availableSegments.FindAll(x => x.beginY1 == y1 || x.beginY2 == y2 || x.beginY3 == 3);
    ...
    {
        List<Segment> possibleTransition = availableTransitions.FindAll(x => x.beginY1 == y1 || x.beginY2 == y2 || x.beginY3 == 3);
